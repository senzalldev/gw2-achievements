  ...
  <div class="bg-slate-800 rounded-xl p-5 border border-slate-700">
    <div class="flex items-center justify-between mb-1">
      <h3 class="font-semibold text-white">
        Almost Done
        <span class="text-amber-400">({{ items.length }})</span>
      </h3>
      <button
    ...
    <p class="text-xs text-slate-500 mb-4">Your furthest-along incomplete achievements — click any to see what's left and how to finish it</p>
        ...
        >
          <div class="flex-1 min-w-0">
            ...
            <div class="flex items-center gap-2 mt-1.5">
              ...
              <span class="text-xs text-slate-400 font-mono whitespace-nowrap">{{ item.progressPercent }}%</span>
            </div>
          </div>

          <div class="text-right shrink-0">
            <div class="text-xs font-semibold text-purple-400">{{ item.earnedPoints }}/{{ item.totalPoints }} AP</div>
